...
public abstract class RequestDTO {
            ...
            try {
                ...
                if (field.isAnnotationPresent(NotEmpty.class)) {
                    if (fieldIsEmpty(field, this)) {
                        addError(fieldName, String.format("Veld %s mag niet leeg zijn!", fieldName));
                        continue;
                    }
                }
                if( field.getType().equals(int.class) ||
                        ...
                        field.getType().equals(float.class)) {
                    validateNumberField(field, fieldName);
                }
    ...
    private void validateNumberField(Field field, String fieldName) throws IllegalAccessException {
        ...
        if(field.isAnnotationPresent(MinValue.class)) {
            ...
            if(value < minValue) {
                addError(fieldName, String.format("%s moet minimaal %d zijn!", fieldName, minValue));
            }
        }
